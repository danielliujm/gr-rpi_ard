...
int32_t map_pwm_to_speed (double pwm){
  int32_t speed = static_cast<int32_t> (pwm * 60000/100);
  return speed ;
}
...
void setup_outlets() {
  ...
  // stepper_driver_1.moveAtVelocity(map_pwm_to_speed (100));
  //   delay (10);
  // stepper_driver_2.moveAtVelocity(map_pwm_to_speed (100));
  //   delay (10);
  // stepper_driver_3.moveAtVelocity(map_pwm_to_speed (100));
  //   delay (10);
  // stepper_driver_4.moveAtVelocity(map_pwm_to_speed (100));
  //   delay (10);
  // stepper_driver_5.moveAtVelocity(map_pwm_to_speed (100));
  //   delay (10);
  // stepper_driver_6.moveAtVelocity(map_pwm_to_speed (100));
  //   delay (10);
